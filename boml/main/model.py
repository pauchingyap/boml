...
class _ConvNet(metaclass=ABCMeta):
    def __init__(self, num_way, num_in_ch=1, num_conv_layer=4, num_filter=64, kernel_size=3, maxpool_kernel_size=2,
...
class ConvNet(_ConvNet, MetaModule):
    def __init__(self, num_way=5, num_in_ch=1, num_conv_layer=4, num_filter=64, kernel_size=3, maxpool_kernel_size=2,
                 stride=1, padding=1, fc_in_dim=1, num_fc_layer=1, num_fc_hidden=5):
        super(ConvNet, self).__init__(num_way, num_in_ch, num_conv_layer, num_filter, kernel_size, maxpool_kernel_size,
...
class ConvNetMonteCarlo(_ConvNet, MetaModuleMonteCarlo):
    def __init__(self, num_way=5, num_in_ch=1, num_conv_layer=4, num_filter=64, kernel_size=3, maxpool_kernel_size=2,
                 stride=1, padding=1, fc_in_dim=1, num_fc_layer=1, num_fc_hidden=5):
        super(ConvNetMonteCarlo, self).__init__(
            num_way, num_in_ch, num_conv_layer, num_filter, kernel_size, maxpool_kernel_size, stride, padding,
            fc_in_dim, num_fc_layer, num_fc_hidden
        )
        self.classifier = MetaLinearMonteCarlo(self.fc_dim_ls[-1], self.num_way, bias=True)
